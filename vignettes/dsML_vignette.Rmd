---
title: "New DataSHIELD functions proposal and details"
author:
...
bibliography: ds_new_functions_Vignette.bib
...
dslite.server <- newDSLiteServer(tables=list(iris1 = iris1, iris2 = iris2),
                                 config = DSLite::defaultDSConfiguration(include=c("dsBase", "resourcer")))
